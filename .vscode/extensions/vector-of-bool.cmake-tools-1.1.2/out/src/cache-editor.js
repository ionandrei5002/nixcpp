...
class CacheEditorContentProvider {
    constructor(_ctx, _port) {
        this._ctx = _ctx;
        this._port = _port;
    }
...
exports.CacheEditorContentProvider = CacheEditorContentProvider;
//# sourceMappingURL=cache-editor.js.map